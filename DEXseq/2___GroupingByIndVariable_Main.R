...
inDir="/path/to/input/directory/containing/reference/files/including/gff"
...
png('/path/to/plot/folder/Date__Description___MA_Plot.png',width = 2200, height = 1200, res=300)
plotMA( dxr, cex=0.8 )
dev.off()
...
output_directory <- "/path/to/plot/folder/of/your/choice/"
setwd(output_directory)

# Sample list of Ensembl IDs (real ids used not shown - example below)
ensembl_ids <- c("ENSDARG00000001111+ENSDARG00000012222",
                 "ENSDARG00000003333",
                 "ENSDARG00000004444")
...
output_directory <- "/path/to/Date___Legend_Removed"

setwd(output_directory)

# Sample list of Real IDs Used Not Shown
ensembl_ids <- c("ENSDARG00000001234+ENSDARG00000023456",
                 "ENSDARG0000007890+ENSDARG0000001111+ENSDARG00000002222")
