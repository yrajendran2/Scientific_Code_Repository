# SubStep 13: Merging In Strand Information

* This is used on REDItools Stranded data only. It is optional.

## Scaffold Protocol:

### Protocol For Part 1: Merging In First Four Columns From SubStep 1:

1) Editing R script to have the following inputs described in detail below:

| Variable(s)                    | Description(s)                                                                                        | 
|----------|----------|
| `input_directory`              | Path to your SubStep 1 Removal Of K And Mitochondrial regions folder                                     | 
| `output_directory`             | Path to your SubStep 13 Merging In Strand Information Part 1 Merging In First Four Columns From SubStep 1   |
...
|----------|----------|
| `Step_12_TSV`    | Path to the `tsv` created in SubStep 12   | 
| `file_path_tsv`    | Path to the SubStep 13 Part 1 `.tsv` file   | 
