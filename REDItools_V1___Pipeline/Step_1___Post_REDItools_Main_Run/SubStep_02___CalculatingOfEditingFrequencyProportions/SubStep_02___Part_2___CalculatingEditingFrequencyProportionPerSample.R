...
# SubStep 02: Calculating Editing Frequency Proportion Per Sample
...
# Specify the directory containing your files (SubStep 1 Removal Of K And Mitochondrial Regions directory path)
input_directory_path <- "path/to/your/SubStep1/directory"
...
output_folder_name <- "SubStep_02___CalculatingEditingFrequencyProportionPerSample"
