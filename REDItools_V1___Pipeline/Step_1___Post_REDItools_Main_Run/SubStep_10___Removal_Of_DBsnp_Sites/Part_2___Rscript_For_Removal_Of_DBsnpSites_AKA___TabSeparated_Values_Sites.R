...
visual_file <- "path/to/SubStep_07___MergeIn/PreFiltration_Type/Part_2___FullMerge/Full_Merged.tsv"
...
output_directory <- "/path/to/SubStep_10___Removal_Of_DBsnp_Sites/PreFiltration_Type"
# Specify a basename for the prefix added to your output files
output_file_basename <- "SubStep_10___YourDescriptor___"
