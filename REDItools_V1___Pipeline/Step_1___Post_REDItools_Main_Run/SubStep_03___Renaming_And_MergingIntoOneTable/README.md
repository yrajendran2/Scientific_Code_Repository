# SubStep 03: Renaming And Merging In Relevant Columns Into One Table

## Protocol For SubStep 03: Renaming And Merging In Relevant Columns Into One Table:

### SubStep 03 Part 1: Rename Individual Sample Files To Have The Sample Name In The Column Name
...
1) Edit the `input_directory_path` in the R script (found in SubStep 3 Merging Into One Tables Part 1 subfolder) to have the path to the SubStep_02 Removal Of K Contigs And Mitochondrial Transcripts directory.
...
1) Edit the R script found in the sub-step 03 part 2 directory to have the following inputs:
