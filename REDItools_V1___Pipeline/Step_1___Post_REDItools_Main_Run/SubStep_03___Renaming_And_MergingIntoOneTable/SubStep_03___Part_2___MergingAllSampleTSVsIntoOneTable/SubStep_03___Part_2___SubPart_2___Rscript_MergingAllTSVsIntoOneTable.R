...
# Specify the output directory and subfolder names (the merged file sub-step folder)
## SubStep 3 Merging Folder Path
output_directory_path <- "/path/to/SubStep_03___RenamingRelevantColumns_And_MergingIntoOneTable"
